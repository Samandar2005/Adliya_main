...
urlpatterns = [
    ...
    path('department/edit/<int:pk>', DepartmentUpdateView.as_view(), name='department-edit'),
    ...
    path('subdepartment/<int:pk>', SubDepartmentDetailView.as_view(), name='subdepartment-detail'),
